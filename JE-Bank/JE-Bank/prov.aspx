...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div> 
        <div class="box">
            <h5>Kompetensprov</h5>
            <p>Kompetensprov innehåller 15 frågor som du ska minsta ha 70% rätt på för att klara.</p>
        </div>
        <div class="box">
    ...
    <div>
        <div class="box">
            <h5>Licensprovet</h5>
            <p>Licensprov innehåller 25 frågor som du ska minsta ha 70% rätt på för att klara.</p>
        </div>
        <div class="box">
